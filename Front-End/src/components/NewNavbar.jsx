    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <nav className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          <Link to="/buscar" className="text-gray-600 hover:text-gray-800 transition-colors">
            Buscar Cuidadores
          </Link>
          <Link to="/servicios" className="text-gray-600 hover:text-gray-800 transition-colors">
            Servicios
          </Link>
          <Link to="/como-funciona" className="text-gray-600 hover:text-gray-800 transition-colors">
            Cómo Funciona
          </Link>
          <Link to="/ayuda" className="text-gray-600 hover:text-gray-800 transition-colors">
            Ayuda
          </Link>
        </div>
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          {user && (
            <>
              {user.role === 'owner' && (
                <>
                  <Link to="/owner/book" className="text-gray-600 hover:text-gray-800 transition-colors">
                    Reservar
                  </Link>
                  <Link to="/owner/bookings" className="text-gray-600 hover:text-gray-800 transition-colors">
                    Mis reservas
                  </Link>
                </>
              )}
              {user.role === 'sitter' && (
                <Link to="/sitter" className="text-gray-600 hover:text-gray-800 transition-colors">
                  Panel cuidador
                </Link>
              )}
              {user.role === 'admin' && (
